package com.lyu.csdndemo.common.base.controller;
...
public abstract class GenericController<T, Q extends QueryBase> {
    ...
    protected String getPageBaseRoot() throws Exception {
        if (basePath == null) {
            ...
            if (m.find()) {
                ...
                basePath = basePath.substring(0, basePath.lastIndexOf("/") + 1) + toFirstCharLowerCase(basePath
                        .substring(basePath.lastIndexOf("/") + 1));
            } else {
    ...
    public Map<String, Object> removeBath(String json) throws Exception {
        Map<String, Object> result = new HashMap<>();
        getService().removeBath((List<T>) JsonHelper.toList(json, (Class<T>) ((ParameterizedType) getClass()
