...
public class GenCodeUtil {
     ...
     * @return
     */
    private static String genJavaBeanFromTableStructure(String author, TableModel table, String beanName, String
            packagePath) {
        ...
        try {
            ...
            for (ColumnModel columnModel : columnModelList) {
                sb.append(
                        "\tpublic " + columnModel.getColumnClassName() + " get" + toFirstCharUpCase((String)
     ...
     * @return
     */
    private static String genQueryModelFromTableStructure(String author, TableModel table, String beanName, String
            extendsBasePackage, String packagePath) {
        StringBuffer sb = new StringBuffer();
        if (StringUtils.isNotEmpty(packagePath)) {
            sb.append("package " + packagePath + ";\n\n");
        }
     ...
     * @return
     */
    private static String genDao(String author, String packagePath, String beanName, String queryModelName, String
            extendsBasePackage) {
        StringBuffer sb = new StringBuffer();
        if (StringUtils.isNotEmpty(packagePath)) {
            sb.append("package " + packagePath + ";\n\n");
     ...
     */
    public static void genFiles(String author, String catalog, String tableName, String extendsBasePackage, String
            basePackage,
                                String mybatisBasePath, String beanName, String queryModelName, String properitesUri)
            throws IOException {
        String packagePath = basePackage.replaceAll("\\.", "/");
        JdbcUtil.setPropertiesURL(properitesUri);
        TableModel table = JdbcUtil.getTableStructure(catalog, tableName);
